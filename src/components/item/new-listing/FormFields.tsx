  ...
  return (
    <>
      ...
      <FormGroup>
        ...
        <Select id="format" name="format" onChange={onChange} required value={formData.format} disabled={isSubmitting}>
      ...
      <FormGroup>
        ...
        <Select id="condition" name="condition" onChange={onChange} value={formData.condition} disabled={isSubmitting}>
